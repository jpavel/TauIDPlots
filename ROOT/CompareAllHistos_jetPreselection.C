...
int CompareAllHistos(TString input1 = "../../ZTT_ref.root", TString input2 = "../../ZTT_filter.root") {
  ...
  TString suffix_12[n12] = {"_DM","_DMall"};
 ...
 // std::stringstream name;
  for(uint iFile = 0; iFile < nFiles; iFile++)
  {
	...
	{		
		profileHist1[iProf12][iFile]=(TProfile*)f[iFile]->Get(TString(dirNames[0]+"/"+prefix_12+profileNames_12[iProf12]));
		profileHist2[iProf12][iFile]=(TProfile*)f[iFile]->Get(TString(dirNames[0]+"/"+prefix_12+profileNames_12[iProf12]));
	}
  }
  ...
  // plotting
   ...
   // c1->SetLogy();
	...
	for(uint iProf12=0; iProf12< nProfile12; iProf12++)
	{
		 ...
		 profileHist1[iProf12][0]->GetYaxis()->SetTitle("tau efficiency");
	     ...
	     profileHist1[iProf12][0]->SetMaximum(1.0);
	     profileHist1[iProf12][0]->SetMinimum(0.0);
		...
		leg->AddEntry(profileHist1[iProf12][0], "no cut", "lp");
		leg->AddEntry(profileHist1[iProf12][1], "jet filter", "lp");
