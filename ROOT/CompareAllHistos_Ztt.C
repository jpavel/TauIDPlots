 ...
 // std::stringstream name;
  ...
  // plotting
	...
	for(uint iProf12=0; iProf12< nProfile12; iProf12++)
	{
		 ...
		 profileHist1[iProf12][0]->GetYaxis()->SetTitle("Efficiency");
	     ...
	     double max = 1.05*(profileHist1[iProf12][0]->GetBinContent(binmax)+profileHist1[iProf12][0]->GetBinError(binmax));
  ...
  for(uint iWP=0; iWP<nWP; iWP++)
		...
		//~ 
					if(title_id==0) profileHist[i123][iWP*nProfile+iProf123][0]->GetXaxis()->SetRangeUser(10,100);
					 ...
					 profileHist[i123][iWP*nProfile+iProf123][0]->GetYaxis()->SetTitle("Efficiency");
				     ...
				     double max = 1.05*(profileHist[i123][iWP*nProfile+iProf123][0]->GetBinContent(binmax)+profileHist[i123][iWP*nProfile+iProf123][0]->GetBinError(binmax));
				     int binmax2 = profileHist[i123][iWP*nProfile+iProf123][1]->GetMaximumBin();
				     double max2 = 1.05*(profileHist[i123][iWP*nProfile+iProf123][1]->GetBinContent(binmax2)+profileHist[i123][iWP*nProfile+iProf123][1]->GetBinError(binmax2));
				     max = max2 > max ? max2 : max;
